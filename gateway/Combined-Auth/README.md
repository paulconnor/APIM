This policy was created for a demo that required multiple forms of authentication plus rate throttling in front of a backend service that could be at a primary or DR backend site.
